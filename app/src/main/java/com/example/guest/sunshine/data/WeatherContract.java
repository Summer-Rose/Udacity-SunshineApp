package com.example.guest.sunshine.data;
...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.guest.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        public static final String CONTENT_TYPE_ITEM = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_LOCATION;
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeather(long id) {
            return ContentUris.withAppendedId(CONTENT_URI, id);
        }
